...
-- -----------------------------------------------------
-- Audit Table `northwind`.`purchase_orders_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`purchase_orders_audit` (
  `id` INT(11) NOT NULL,
  `supplier_id` INT(11) NULL DEFAULT NULL,
  `submitted_date` DATETIME NULL DEFAULT NULL,
  `expected_date` DATETIME NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Audit Table `northwind`.`purchase_order_details_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`purchase_order_details_audit` (
  `id` INT(11) NOT NULL,
  `purchase_order_id` INT(11) NOT NULL,
  `product_id` INT(11) NULL DEFAULT NULL,
  `quantity` DECIMAL(18,4) NOT NULL,
...
-- -----------------------------------------------------
-- Audit Table `northwind`.`products_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`products_audit` (
  `id` INT(11) NOT NULL,
  `product_code` VARCHAR(25) NULL DEFAULT NULL,
  `product_name` VARCHAR(50) NULL DEFAULT NULL,
  `standard_cost` DECIMAL(19,4) NULL DEFAULT '0.0000',
...
-- -----------------------------------------------------
-- Audit Table `northwind`.`shippers_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`shippers_audit` (
  `id` INT(11) NOT NULL,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL
...
-- -----------------------------------------------------
-- Audit Table `northwind`.`customers_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`customers_audit` (
  `id` INT(11) NOT NULL,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL
...
-- -----------------------------------------------------
-- Audit Table `northwind`.`employees_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`employees_audit` (
  `id` INT(11) NOT NULL,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL
...
-- -----------------------------------------------------
-- Audit Table `northwind`.`order_details_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`order_details_audit` (
  `id` INT(11) NOT NULL,
  `order_id` INT(11) NOT NULL,
  `product_id` INT(11) NULL DEFAULT NULL,
  `quantity` DECIMAL(18,4) NOT NULL DEFAULT '0.0000',
...
-- -----------------------------------------------------
-- Audit Table `northwind`.`orders_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`orders_audit` (
  `id` INT(11) NOT NULL,
  `employee_id` INT(11) NULL DEFAULT NULL,
  `customer_id` INT(11) NULL DEFAULT NULL,
  `order_date` DATETIME NULL DEFAULT NULL,
