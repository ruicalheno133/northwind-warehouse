...
CREATE SCHEMA IF NOT EXISTS `northwind_dw` ;
USE `northwind_dw` ;
...
CREATE TABLE IF NOT EXISTS `northwind_dw`.`DIM_SHIPPER` (
  `shipper_key` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `northwind_dw`.`FACT_ORDER` (
  ...
  `shipped_date` INT(11) NOT NULL,
  `paid_date` INT(11) NOT NULL,
  `customer_key` INT(11) NOT NULL,
  `employee_key` INT(11) NOT NULL,
  `shipper_key` INT(11) NOT NULL,
  `ship_location` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `northwind_dw`.`FACT_PURCHASE` (
  `purchase_key` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`customers_staging`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`employees_staging`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`order_details_staging`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`orders_staging`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`products_staging`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`purchase_order_details_staging`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`purchase_orders_staging`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`shippers_staging`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `northwind_dw`.`suppliers_staging`
-- -----------------------------------------------------
